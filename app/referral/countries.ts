...
// Mirrors the backend's onboarding country-of-residence allowlist
// (mvp/repos/backend corebanking/corebanking/business/userregistration/
// AvailableResidencyCountries.cs, served at GET /onboarding/available-residency/all):
// the full ISO 3166-1 list minus the territories Onfido can't verify ID
// documents for. Sorted alphabetically by display name, same as the
// backend's own GetAll() ordering.
export const dialCountries: DialCountry[] = [
  ...
  { iso2: "KR", name: "Korea, Republic of", dial: "82" },
  ...
  { iso2: "MD", name: "Moldova, Republic of", dial: "373" },
  ...
  { iso2: "SX", name: "Sint Maarten (Dutch part)", dial: "1" },
  ...
  { iso2: "TW", name: "Taiwan, Province of China", dial: "886" },
  ...
  { iso2: "TT", name: "Trinidad & Tobago", dial: "1" },
  ...
  { iso2: "VG", name: "Virgin Islands (British)", dial: "1" },
...
export function findDialCountry(iso2: string): DialCountry {
  return dialCountries.find((country) => country.iso2 === iso2) ?? dialCountries[0];
}
