...
// ISO 3166-1 alpha-2 code and E.164 calling code for each country.
// Kept broad (not exhaustive) so the picker covers the product's stated
// "190+ countries" reach without shipping every micro-territory.
